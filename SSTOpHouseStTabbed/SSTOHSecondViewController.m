...
#import "SSTOHSecondViewController.h"

@interface SSTOHSecondViewController ()
...
@implementation SSTOHSecondViewController
...
-(IBAction)load1:(id)sender
{
    ...
    // 1
    UIImage *image = [UIImage imageNamed:@"mapLevel1.png"];
...
-(IBAction)load2:(id)sender
{
    [self.imageView removeFromSuperview];
    // 1
    UIImage *image = [UIImage imageNamed:@"mapLevel2.png"];
    self.imageView = [[UIImageView alloc] initWithImage:image];
    self.imageView.frame = (CGRect){.origin=CGPointMake(0.0f, 0.0f), .size=image.size};
    [self.scrollView addSubview:self.imageView];
...
-(IBAction)load3:(id)sender
{
    [self.imageView removeFromSuperview];
    // 1
    UIImage *image = [UIImage imageNamed:@"mapLevel4.png"];
    self.imageView = [[UIImageView alloc] initWithImage:image];
    self.imageView.frame = (CGRect){.origin=CGPointMake(0.0f, 0.0f), .size=image.size};
    [self.scrollView addSubview:self.imageView];
